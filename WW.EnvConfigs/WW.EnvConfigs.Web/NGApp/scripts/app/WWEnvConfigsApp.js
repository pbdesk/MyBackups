...
var WWEnvConfigsAppAppName = 'WWEnvConfigsApp';
var WWEnvConfigsApp = angular.module('WWEnvConfigsApp', ['ngRoute']);
WWEnvConfigsApp.config(['$routeProvider', function ($routeProvider) {
    $routeProvider
        .when('/', { templateUrl: '/NGApp/Views/Index.html' })
