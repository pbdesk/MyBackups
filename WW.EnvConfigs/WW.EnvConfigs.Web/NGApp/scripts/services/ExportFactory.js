...
(function () {
    ...
    var serviceId = 'ExportFactory';

    // Define the factory on the module.
    // Inject the dependencies. 
    // Point to the factory definition function.
    angular.module(WWEnvConfigsAppAppName).factory(serviceId, ["$http", "$q", ExportFactory]);

    function ExportFactory($http, $q) {
        ...
        var _runExport = function (eiParamsObj) {
            var deferred = $q.defer();

            $http.post(_url, eiParamsObj)
            .then(
                function (result) {
                    //success
